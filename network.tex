...
\begin{tikzpicture}[remember picture]
	...
	\node[
		...
		\begin{tcboxedraster}[services raster]{services box}
			...
			\tcbox[enhanced, remember as=raspberrypi-cockpit]{\service{}{cockpit}{\http{cockpit.internal.lan}}}
		\end{tcboxedraster}
	};
	...
	% --------------- start guest devices ---------------
	\node[host description, below=4em of raspberrypi-host-box.south, anchor=north, inner sep=0em] (guest-devices-usb) {
		\begin{tcboxedraster}[devices raster]{%
			devices box,
			title={Guest Devices\hspace{1em}\ip{192.168.0.0/24}{subnet-home}},
	...
	\begin{scope}[ethernet]
		\draw[subnet-home] (raspberrypi-usb0.west) -- ++(-1,0) |- (guest-devices-usb.west);
		\draw[subnet-home] (raspberrypi-usb1.west) -- ++(-1,0) |- (guest-devices-usb.west);
